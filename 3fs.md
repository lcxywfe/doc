...
## meta node
* `docker exec --env STORAGE_NODE_NUM=2 --env STORAGE_NODE_BEGIN=10001 --env STORAGE_NODE_END=10002 --env REPLICATION_FACTOR=2 --env NUM_DISKS_PER_NODE=7 --env MGMTD_SERVER_ADDRESSES="RDMA://192.168.0.72:8000" meta ./config_3fs.sh`
  * `STORAGE_NODE_NUM`
  * `STORAGE_NODE_BEGIN`
  * `STORAGE_NODE_END`
  * `REPLICATION_FACTOR`
